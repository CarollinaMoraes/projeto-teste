...
func main() {
	...
	const f string = "Hello, Felipe Bobudo!"
	fmt.Println(f)
...
// escreva uma funcao que retorne string
// Dica: funcao que concatena palavras
// Exemplo: concaternar("Eu odeio", "Segunda-feira") deve retornar "Eu odeio Segunda-feira"

// escreva uma funcao que retorne bool
// Dica: Checar se um numero é par
// Examplo: ehPar(2) deve retornar true
// tente fazer sozinah e depois pesqusar no google esse
